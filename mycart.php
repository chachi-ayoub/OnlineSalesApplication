...
<body style="background-color:#1b7899;">
	...
	<div style=" padding: 0 10%;">
		<div style=" margin: 0 auto; width: 55%;float: left;margin-top:40px;">
					...
					<div>
						<div>
							<table class="rightsidemenu">
								<tr style="font-weight: bold;" colspan="10" bgcolor="#516370">
									<th>Product Name</th>
									<th>Price</th>
									<th>Pieces</th>
									<th>Description</th>
		...
		$result = mysqli_query($con,"SELECT * FROM user WHERE id='$user'");
			$get_user_email = mysqli_fetch_assoc($result);
				...
				echo '<h3 style="color:#169E8F;font-size:35px;"> Total: '.$_SESSION['total'].' Dhs</h2>';
								...
								<form action="" method="POST" class="registration">
									...
									<h3 style="color:red;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
										...
										Types of Delivery <br>
										 ...
										 <input name="Delivery" required="required" value="Express Delivery +100php upon cash on delivery" type="radio"  placeholder="Mode Of Payment" style"color:black;"> Amana </br>
										 <input name="Delivery" type="radio" value="Standard Delivery" required="required" placeholder="Mode Of Payment" style"color:black;"> Poste Maroc </br>
										 </font>
