	...
	<body class="home-welcome-text" style="background-color:#1b7899;" >
		<div class="homepageheader" style="position: inherit;">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton" style="">
					<a style="text-decoration: none;color:#fff;" href="login.php">USER LOG IN</a>
				</div>
				<div class="uiloginbutton signinButton loginButton" style="margin-right: 40px;">
					<?php
		...
		<?php
			if(isset($success_message)) {echo $success_message;}
				...
				echo '
					<div class="holecontainer" style="float: right; margin-right: 36%; padding-top: 26px;margin-top:50px;">
