		...
		<div class="homepageheader">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton">
					<?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: #fff;" href="update_admin.php">Hi '.$uname_db.'</br><span style="color: #de2a74"></span></a>';
						}
						else {
				...
				echo '
					<div class="holecontainer" style="float: right; margin-right: 36%; padding-top: 20px;">
						<div class="container">
							<div>
								<div>
									<div class="signupform_content" style="background-color: white;opacity: 0.6;border-radius: 10px;">
