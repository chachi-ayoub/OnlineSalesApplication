		...
		<div class="homepageheader">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton">
					 <?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: #fff;" href="login.php">Hi '.$uname_db.'<span style="color: #de2a74"></span></a>';
	  ...
	  <ul>
		...
		<?php
			if(isset($success_message)) {echo $success_message;}
				...
				echo '
					<div class="holecontainer" style="float: right; margin-right: 30%; padding-top: 20px;">
						<div class="container">
							<div>
								<div>
									<div class="signupform_content">
										...
										<div>
											...
											<div class="label_content1" style="float: left;">
  											<h5>Item:</h5>
												...
												<select name="item" required="required" style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid black;color: black;margin-left: 195px;width: 300px;background-color: transparent;" class="">
											...
											<input name="profilepic"style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid black;color: black;margin-left: 152px;width: 270px;background-color: transparent;" class="password signupbox" type="file" value="Add Pic">
											</div></br>


											<div>
											<input name="signup"  style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #169E8F;color: black;margin-left: 260px;width: 304px;background-color: transparent;" class="uisignupbutton signupbutton" type="submit" value="Add Product">
											</div>
											</div>
											</form>
